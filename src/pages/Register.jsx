...
// // --- Icons ---
// import { UserPlus, Mail, Lock, UserCheck, ChevronLeft, Loader2, Shield } from 'lucide-react';
...
//     // Initial loading toast (Light Theme)
//     const regToastId = toast.loading("Creating Secure Account...", { theme: "light" });
...
//       {/* Toastify Container - Global Light Theme */}
...
//             <div className="h-16 w-16 bg-indigo-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-indigo-200 mx-auto mb-6">
//               <UserPlus size={32} />
//             </div>
...
//             <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-2">Create your medical credentials</p>
//           </div>
...
//               type="submit" 
//               disabled={loading}
//               className={`w-full py-6 rounded-2xl font-black text-lg uppercase tracking-widest shadow-xl transition-all active:scale-95 flex items-center justify-center gap-3
...
//             Already registered? <span className="text-indigo-600 cursor-pointer hover:underline" onClick={() => navigate('/')}>Login Here</span>
//           </p>
//         </div>
//       </div>
//     </div>
...
//         <button 
//           onClick={() => navigate('/')}
//           className="mt-8 px-10 py-4 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-indigo-600 transition-all"
//         >
//           Return to Login
//         </button>
//       </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="relative group">
              ...
              <select 
                ...
                value={formData.role}
              >
                <option value="patient" className="cursor-pointer">Patient</option>
                <option value="doctor" className="cursor-pointer">Doctor</option>
                <option value="admin" className="cursor-pointer">Admin</option>
                <option value="receptionist" className="cursor-pointer">Receptionist</option>
              </select>
            </div>
